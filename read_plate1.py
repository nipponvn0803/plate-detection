...
img_path = "C:/Users/vuong/Desktop/new1/Detection_LP/test040.jpg"
...
if (len(LpImg)):
    ...
    cv2.imshow("1234",binary)
    cv2.waitKey()
    ret3,binary = cv2.threshold(binary,0,255,cv2.THRESH_BINARY+cv2.THRESH_OTSU)
